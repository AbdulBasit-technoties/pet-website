                ...
                <div className="top-header py-3">
                    <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-[40px] 2xl:px-[50px]">
                        <div className="grid grid-cols-2 items-center justify-between gap-y-4">
                            ...
                            <div className="flex">
                                <div className="logo">
                                    <Link href={route("home")} className="block w-[60px] sm:w-[80px] lg:w-[100px]">
                            ...
                            <div className="flex justify-end items-center gap-4">
                                <ul className="flex justify-center sm:justify-end items-center gap-3 order-2">
                                    <li>
                                        <a
                                            ...
                                            className="w-[35px] h-[35px] sm:w-[42px] sm:h-[42px] sm:w-[46px] sm:h-[46px] bg-custbg flex items-center justify-center rounded text-[rgba(77, 82, 103, 1)] text-[20px] sm:text-[24px] transition-all duration-500 hover:bg-c1 hover:text-white"
                                        >
                                            <IoCallOutline />
                                        </a>
                                    </li>
                                ...
                                <div className="flex justify-center sm:justify-end order-1 hidden sm:block">
